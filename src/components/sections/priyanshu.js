            ...
            <div id="blur">
                ...
                <center>
                    <div className="iframeContainer">
                        <iframe style={{ marginTop: "3%", borderRadius: "20px", marginBottom: "-3%" }} width="560" height="308" src="https://www.youtube.com/embed/8l2RVSIhSgo?playlist=8l2RVSIhSgo&loop=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </center>
            ...
            Your browser does not support the video tag.
                ...
                <div className="stdtcard" style={{
                    ...
                    <div className="detail" style={{ width: "100%", margin: "auto" }}>
                        ...
                        >
                            <ul>
                                <li>Name: Priyanshu Pandey</li>
                                <li>Location: Delhi</li>
                                <li>Age: 16</li>
                                <li>School: Rajdhani Public School</li>
                            </ul>
                        </p>
                    </div>
